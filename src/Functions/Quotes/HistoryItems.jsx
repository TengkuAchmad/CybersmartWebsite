...
const HistoryItems = () => {
    ...
    const fetchDataLog = useCallback(() => {
      axios
        .get('https://cybersmartserver.as.r.appspot.com/GetLogQuote')
        .then((response) => {
