...
const HistoryItems = () => {
    ...
    const fetchDataLog = useCallback(() => {
      axios
        .get('https://cybersmartserver.as.r.appspot.com/GetLogDocRequest')
        .then((response) => {
    ...
    const getStatusClass = (action) => {
        if (action === "Update on Ticket Document Request"){
            return "status-add-news"
        } else if (action === "Delete Services"){
            return "status-delete-news"
        } else if (action === "Activate Services"){
            return "status-activate-news"
        } else if (action === "Deactivate Services"){
            return "status-deactivate-news"
        } else if (action === "Update on status Document Request"){
            return "status-update-news"
        } else {
            return "status-add-news"
        }
    }
