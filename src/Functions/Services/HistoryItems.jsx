...
const HistoryItems = () => {
    ...
    const fetchDataLog = useCallback(() => {
      axios
        .get('https://cybersmartserver.as.r.appspot.com/GetLogService')
        .then((response) => {
    ...
    const getStatusClass = (action) => {
        if (action === "Add New News"){
            return "status-add-news"
        } else if (action === "Delete News"){
            return "status-delete-news"
        } else if (action === "Activate News Banner"){
            return "status-activate-news"
        } else if (action === "Deactivate News Banner"){
            return "status-deactivate-news"
        } else if (action === "Update Status Service"){
