...
// COMPONENTS IMPORT
import ServicesHandle from "../Functions/ServicesHandle"
        ...
        <>
            <FadeTransition>
                <Container fluid className="DashboardContainer">
                    <Row>
                        <Col xs lg="1">
                            <Nav defaultActiveKey="/services" className="flex-column navbar-side pt-3 pb-3 text-center">
                                <Row className='mt-5 mb-3'><Nav.Link href= "/dashboard"><img src={Home} className='icons' alt="icon-dashboard"></img>Beranda</Nav.Link></Row>
                                <Row className='mb-3'><Nav.Link href= "/services"><img src={Services} className='icons-active' alt="icon-dashboard"></img>Layanan</Nav.Link></Row>
                        ...
                        <Col xs lg="2">
                            <Nav defaultActiveKey="/services" className="flex-column pt-3 pb-3 text-center">
                                <ServicesHandle />
                            </Nav>
                        </Col>
