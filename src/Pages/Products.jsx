...
// COMPONENTS IMPORT
import ProductsHandle from "../Functions/ProductsHandle"
        ...
        <>
            <FadeTransition>
                <Container fluid className="DashboardContainer">
                    <Row>
                        <Col xs lg="1">
                            <Nav defaultActiveKey="/products" className="flex-column navbar-side pt-3 pb-3 text-center">
                                ...
                                <Row className='mb-5'><Nav.Link href= "/products"><img src={Cart} className='icons-active' alt="icon-dashboard"></img>Produk</Nav.Link></Row>
                                <Row className='mt-2 mb-1'><Nav.Link href= "/logout"><img src={Version} className='icons' alt="icon-dashboard"></img>Keluar</Nav.Link></Row>
                            </Nav>
                        </Col>

                        <Col xs lg="2">
                            <Nav defaultActiveKey="/products" className="flex-column pt-3 pb-3 text-center">
                                <ProductsHandle />
                            </Nav>
                        </Col>
